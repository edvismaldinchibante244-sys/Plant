...
// Busca itens destinados ao bar, status em_preparo ou pronto
$stmt = $db->prepare("
...
<body>
    <div class="kds-topbar">
        <div class="kds-title">Bar - Itens do Dia</div>
    ...
    <script>
        ...
        const storageKey = 'kds_bar_counts';
        const countByStatus = () => {
